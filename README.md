...
- **Textbook**: We will not follow any one textbook too closely. Here are a few references we will use:
  ...
  - _Deep Learning: Foundations and Concepts_ by Christopher M. Bishop and Hugh Bishop. Bishop's earlier machine learning textbooks (_Neural Networks for Pattern Recognition_ and _Pattern Recognition and Machine Learning_) have been extremely popular. The "new Bishop" (as Yann LeCun puts it) will be no different! Online version available [here](https://www.bishopbook.com/) and ebook and printed version can be obtained via [Springer](https://link.springer.com/book/10.1007/978-3-031-45468-4).
